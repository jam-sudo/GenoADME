...
Status: pre-release (v0.3 closing). Tier 1 validation re-run 2026-05-08 under Sisyphus pin `bf764c5` (v0.3.3 / PR #33 — `phenotype_scale_overrides` API hook closing Sisyphus #31) WITH GenoADME's per-substrate calibration override applied (SLCO1B1 PM scale 0.30 vs CPIC default 0.10, calibrated to Niemi 2006 men-stratum 95% CI lower bound per [`docs/v0.3-meta-analysis.md`](docs/v0.3-meta-analysis.md)) — **result: PASS**. Current canonical: [`reports/validation-tier1-20260508.md`](reports/validation-tier1-20260508.md) / [`reports/headline-metrics-20260508.json`](reports/headline-metrics-20260508.json). All three criteria pass: Population AAFE (AUC) 1.845 ≤ 2.0; PM/EM AUC ratio 1.719 ∈ [1.4, 2.5]; PM/EM Cmax ratio 1.551 ≥ 1.3. The v0.2 PARTIAL → v0.3 PASS transition is documented across two same-date 2026-05-08 reports: a baseline-no-override run (commit `8bc3517`, PARTIAL) and the override-integrated v0.3 closing run (this commit). All five Tier 1 runs (2026-04-29, 2026-05-01, 2026-05-03, 2026-05-08-baseline, 2026-05-08-override) are part of the audit chain ([`reports/audit-log.jsonl`](reports/audit-log.jsonl)) with `worktree_clean` + `deps.sisyphus` fields per the [`audit.log_query` gate](src/genoadme/audit.py) (GenoADME issue #1).

...
|**v0.3 — CPIC PM=0.10× scale investigation** ✅ closed |[milestone/3](https://github.com/jam-sudo/GenoADME/milestone/3) |[Sisyphus #31](https://github.com/jam-sudo/Sisyphus/issues/31) closed by PR #33 (v0.3.3, 2026-05-08) |Closed 2026-05-08 with PASS via `metric-change:` commit `a13d2d9`. P-ii path executed: Sisyphus PR #33 added a `phenotype_scale_overrides` API hook; GenoADME-side per-substrate calibration (SLCO1B1 PM scale 0.30, anchored on Niemi 2006 men-stratum 95% CI lower bound) brings PM/EM AUC ratio 3.574 → 1.719, all three criteria PASS. Sparse-evidence caveat preserved in [`docs/v0.3-meta-analysis.md`](docs/v0.3-meta-analysis.md) §2.5/§2.8. |

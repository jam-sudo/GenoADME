...
**v0.3 PM/EM AUC band re-spec (PATH 3, 2026-05-09):** Band [1.4, 2.5] → **[1.4, 5.0]** under a `tier-change:` commit, correcting an originally-flawed citation chain. The original [1.4, 2.5] band cited "Niemi 2006 + Pasanen 2007 1.6–2.0×" but the v0.3 meta-analysis showed (a) Pasanen 2007 is on atorvastatin / rosuvastatin, NOT pravastatin, and (b) Niemi 2006's accessible PM/EM AUC ratio data is the men-stratum 232% (95% CI 74–391%, ratio [1.74, 4.91]). The widened band [1.4, 5.0] preserves the direction floor 1.4 and encompasses Niemi 2006 men-stratum 95% CI's upper bound (4.91, rounded to 5.0). See [`docs/tier-changes.md`](tier-changes.md), [`docs/v0.3-meta-analysis.md`](v0.3-meta-analysis.md) §2.10, and [`docs/limitations.md`](limitations.md) §11.
...
|-------|-----------|---------------------------------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
|SLCO1B1|pravastatin|rs4149056 (*5) carriers vs non-carriers|Niemi 2006 men-stratum: 232% greater AUC (CI [74%, 391%], ratio [1.74, 4.91]) in homozygous Poor Function carriers |Population AAFE (AUC) ≤ 2.0; PM vs EM predicted AUC ratio within 1.4–5.0× (band re-spec'd 2026-05-09 PATH 3); PM vs EM Cmax ratio ≥ 1.3×  |
...
- **PM vs EM AUC ratio within 1.4–5.0×** is the magnitude gate. Original v0.1.0 band [1.4, 2.5] was re-spec'd to [1.4, 5.0] on 2026-05-09 (PATH 3 `tier-change:`) after the v0.3 meta-analysis identified that the original band's citation chain was flawed: Pasanen 2007 (one of the two cited references) is on atorvastatin / rosuvastatin, *not* pravastatin, and the cited "1.6–2.0×" range does not appear in Niemi 2006's accessible PM/EM AUC ratio data (which is men-stratum 232%, ratio [1.74, 4.91]). The widened band preserves the direction floor 1.4 and encompasses Niemi 2006 men-stratum 95% CI upper (4.91, rounded to 5.0). Sparse-evidence caveat: the empirical anchor is N=3 PM individuals from a single study sub-cohort; this caveat is documented at [`docs/v0.3-meta-analysis.md`](v0.3-meta-analysis.md) §2.5/§2.10 and [`docs/limitations.md`](limitations.md) §11. The widening is correction of identified citation error, not face-saving; rationale chain is documented in [`docs/tier-changes.md`](tier-changes.md).
